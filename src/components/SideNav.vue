    ...
    <div class="nav">
      <i class="fa-solid fa-bars" @click="toggleMenu"></i>
        ...
        <ul v-if="shouldShowMenu">
            ...
            <li>
                <a href="#photogtaphy" :class="{ active: active === 'photography' }" @click="hideMenu()">{{$t('strings.navPhotography').toUpperCase()}}</a>
            </li>
            <li>
                <a href="#films" :class="{ active: active === 'films' }" @click="hideMenu()">{{$t('strings.navFilm').toUpperCase()}}</a>
            </li>
            <li>
                <a href="#music" :class="{ active: active === 'music' }" @click="hideMenu()">{{$t('strings.navMusic').toUpperCase()}}</a>
            </li>
            <li>
